...
import { getCoinSupply, getHalving } from '../sedra-api-client';
...
const CBox = () => {
    ...
    async function getBlockReward() {
        await fetch('https://api.sedracoin.com/info/blockreward')
            ...
            <table style={{ fontSize: "1rem" }}>
                ...
                <tr>
                    <td className="cardBoxElement align-top">
                        Total</td>
                    <td className="">
                        <div id="coins">{numberWithCommas(circCoins)} SDR
                        </div>
                    </td>
                </tr>
                <tr>
                    <td className="cardBoxElement align-top">Max <span className="approx">(approx.)</span></td>
                    <td className="pt-1">28,700,000,000 SDR</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td className="pt-1">{blockReward} SDR</td>
                </tr>
                <tr>
                    ...
                    <td className="pt-1">{halvingDate}<br /><div className="text-end w-100 pe-3 pt-1" style={{ fontSize: "small" }}>to {halvingAmount} SDR</div></td>
                </tr>
            </table>
        </div>
    </>
